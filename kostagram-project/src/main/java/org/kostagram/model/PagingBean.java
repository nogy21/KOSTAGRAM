...
/**
 * 페이징 처리를 위한 비즈니스 계층의 클래스 PagingBeanEx method 구현순서<br>
...
public class PagingBean {
	 ...
	 * ListController에서 총게시물수를 조회한 후 PagingBeanEx 생성하여<br> 
	 ...
	 *   1그룹       2그룹     3그룹 
	 * ex) 현재 페이지 8 이면 이전페이지 그룹의 마지막 번호 4 이고 여기에 +1 하면 시작페이지번호가 됨
	 * @return
	 */
