...
<header id="header">
   <c:choose>
      ...
      <c:otherwise>
         <div align="right">
         <a href ="SurfPostController.do">
            <img src="images/surfpost.png" width="50" height="35" alt="둘러보기" />
         </a>&nbsp;&nbsp;
         <a href ="PostUploadFormController.do">
            <img src="images/post-update.png" width="60" height="34" alt="글쓰기" />
         </a>&nbsp;&nbsp;
         ...
         <a href ="javascript:logout()" style="text-decoration:none">
             <img src="images/logout2.png" width="45" height="40" alt="로그아웃" />&nbsp;&nbsp;
         </a>
